  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          // SnackBar dengan Action untuk Tambah Data
                          ...
                          child: Column(
                            children: [
                              ...
                              ElevatedButton(
                                child: Text('Save'),
                                onPressed: () {
                                  // Logika konversi warna string ke Object Color
                                  Color finalColor = Colors.grey;
                                  if (col_selected == 'blue') finalColor = Colors.blue;
                                  else if (col_selected == 'green') finalColor = Colors.green;
                                  else if (col_selected == 'yellow') finalColor = Colors.yellow;
